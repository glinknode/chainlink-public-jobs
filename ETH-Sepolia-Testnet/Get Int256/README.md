...
Oracle JobID: 
```
91becd2e225f44f89220b66da5440662
```
...
* API Endpoint : https://raw.githubusercontent.com/glink/chainlink-public-jobs/example-json/example-int256.json
...
Curl command : 
```
curl https://raw.githubusercontent.com/glink/chainlink-public-jobs/example-json/example-int256.json
```
